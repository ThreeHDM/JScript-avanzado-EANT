...
class Producto {
    ...
    Mostrar(){
        /*
        if (this.disponible) {
            //crear una variable con let hace que exista dentro del bloque en el que fue creado. Tiene que ver con el scope en el que vive y muere una variable.
            let color = "green"
        } else {
            let color = "red"
        }
        */
        ...
        document.write(`<p style='color:${color}'>Hay <strong>${this.stock}</strong> unidades de <strong>${this.nombre}</strong> que valen <em>$${this.precio}</em> c/u</p>`)
        */

        //cloneNode() crea una réplica del nodo, el parámetro true permite que se incluyan los childs del nodo
        ...
        //le quito el display none de bootstrap
